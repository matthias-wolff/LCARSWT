...
public class PlanetLayer extends BasicTiledImageLayer
{
  ...
  public PlanetLayer(String wms_url, String planet_name, String data_cache_name,
      String layer_name, String full_layer_label)
  {
  ...
  private static LevelSet makeLevels(String wms_url, String planet_name,
      String data_cache_name, String layer_name)
  {
    ...
    params.setValue(AVKey.DATA_CACHE_NAME, planet_name + "/"
        + data_cache_name.replaceAll(" ", "_").replaceAll("/", "_"));
  ...
  private static class URLBuilder implements TileUrlBuilder
  {
    public URL getURL(Tile tile, String name) throws MalformedURLException
    {
      ...
      // Standard option
      sb.append("&bbox=");
      sb.append("" + west + "," + south + "," + east + "," + north);
