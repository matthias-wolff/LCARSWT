...
public class SWTResourceManager
{
      ...
      final Image decorator, final int corner)
  {
    ...
    synchronized (m_ImageToDecoratorMap)
    {
      decoratedMap = m_ImageToDecoratorMap.get(baseImage);
    ...
    synchronized (decoratedMap)
    {
      ...
      if (result == null)
      {
        ...
        {
          gc.drawImage(decorator, bid.width - did.width - 1,
    ...
    synchronized (m_FontMap)
    {
      ...
      if (font == null)
      {
        ...
        if (strikeout || underline)
        {
          ...
          {
            Log.err("Unable to set underline or strikeout" //$NON-NLS-1$
  ...
  {
    synchronized (m_FontToBoldFontMap)
    {
  ...
  public static Cursor getCursor(int id)
  {
    ...
    synchronized (m_IdToCursorMap)
    {
      Cursor cursor = m_IdToCursorMap.get(key);
      if (cursor == null)
        m_IdToCursorMap.put(key, cursor = new Cursor(Display.getDefault(), id));
      return cursor;
    }
  }
