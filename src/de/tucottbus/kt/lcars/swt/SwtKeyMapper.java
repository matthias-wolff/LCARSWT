...
public class SwtKeyMapper
{
  ...
  static{
    swtAwtKeyMap = new HashMap<>(26);
    swtAwtKeyMap.put(SWT.F1,          KeyEvent.VK_F1);
    swtAwtKeyMap.put(SWT.F2,          KeyEvent.VK_F2);
    swtAwtKeyMap.put(SWT.F3,          KeyEvent.VK_F3);
    swtAwtKeyMap.put(SWT.F4,          KeyEvent.VK_F4);
    swtAwtKeyMap.put(SWT.F5,          KeyEvent.VK_F5);
    swtAwtKeyMap.put(SWT.F6,          KeyEvent.VK_F6);
    swtAwtKeyMap.put(SWT.F7,          KeyEvent.VK_F7);
    swtAwtKeyMap.put(SWT.F8,          KeyEvent.VK_F8);
    swtAwtKeyMap.put(SWT.F9,          KeyEvent.VK_F9);
    swtAwtKeyMap.put(SWT.F10,         KeyEvent.VK_F10);
    swtAwtKeyMap.put(SWT.F11,         KeyEvent.VK_F11);
    swtAwtKeyMap.put(SWT.F12,         KeyEvent.VK_F12);
    swtAwtKeyMap.put(SWT.F13,         KeyEvent.VK_F13);
    swtAwtKeyMap.put(SWT.F14,         KeyEvent.VK_F14);
    swtAwtKeyMap.put(SWT.F15,         KeyEvent.VK_F15);
    swtAwtKeyMap.put(SWT.HELP,        KeyEvent.VK_HELP);
    swtAwtKeyMap.put(SWT.ARROW_LEFT,  KeyEvent.VK_LEFT);
    swtAwtKeyMap.put(SWT.ARROW_RIGHT, KeyEvent.VK_RIGHT);
    swtAwtKeyMap.put(SWT.ARROW_UP,    KeyEvent.VK_UP);
    swtAwtKeyMap.put(SWT.ARROW_DOWN,  KeyEvent.VK_DOWN);
    swtAwtKeyMap.put(SWT.INSERT,      KeyEvent.VK_INSERT);
    swtAwtKeyMap.put((int)SWT.DEL,    KeyEvent.VK_INSERT);
    swtAwtKeyMap.put(SWT.HOME,        KeyEvent.VK_HOME);
    swtAwtKeyMap.put(SWT.END,         KeyEvent.VK_END);
    swtAwtKeyMap.put(SWT.PAGE_UP,        KeyEvent.VK_PAGE_UP);
    swtAwtKeyMap.put(SWT.PAGE_DOWN,         KeyEvent.VK_PAGE_DOWN);
