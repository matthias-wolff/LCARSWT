...
{
  private final ColorMeta cLsr = new ColorMeta(0xCC9999FF,true);
  
  private final ColorMeta cNll = new ColorMeta(0xCCFF0066,true);
  
  private final ColorMeta c1 = new ColorMeta(137,101,70);

  private final ColorMeta c2 = new ColorMeta(137,101,70,64);

  private final ColorMeta c3 = new ColorMeta(0xFF9900);
  ...
  protected void addBar(int bar, ColorMeta color, float nll)
  {
