...
/**
 * Computes the color of the atmosphere according to the Sun position, the eye position and a direction. <p> Based on
 * code from Sean O'Neil "Real-Time Atmospheric Scattering" Gamedev article and C++ demo.<br />
 * http://www.gamedev.net/reference/articles/article2093.asp<br /> http://sponeil.net
 *
