...
//                }
    ...
    public void update(Date date) {
        ...
        logger.log(Level.FINE, "SUN Position @ {0} ({1}): {2}", new Object[]{date, JD, sunPosition});
     ...
     *
     * Original c++ source found here: http://www.psa.es/sdg/archive/SunPos.cpp. Algorithm changed to
     * use alternative greenwich mean sidereal time calculation.
     *
